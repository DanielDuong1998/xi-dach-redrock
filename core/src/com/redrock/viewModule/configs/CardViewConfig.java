...
public class CardViewConfig {
  ...
  static {
    ...
    map2.put(0, new Vector2(581, 549));
    map2.put(1, new Vector2(599, 94));

    map3.put(0, new Vector2(581, 549));
    map3.put(1, new Vector2(201, 94));
    map3.put(2, new Vector2(997, 94));

    map4.put(0, new Vector2(581, 549));
    map4.put(1, new Vector2(201, 304));
    map4.put(2, new Vector2(599, 94));
    map4.put(3, new Vector2(997, 304));

    map5.put(0, new Vector2(581, 549));
    map5.put(1, new Vector2(201, 404));
    map5.put(2, new Vector2(201, 94));
    map5.put(3, new Vector2(997, 94));
    map5.put(4, new Vector2(997, 404));

    map6.put(0, new Vector2(581, 549));
    map6.put(1, new Vector2(201, 404));
    map6.put(2, new Vector2(201, 94));
    map6.put(3, new Vector2(599, 94));
